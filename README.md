...
Para poder pintar se debe definir un lienzo de dos posiciones en javascript. Ej: canvas.getContext("2d")
  ...
  2. **Trazados** En ocasiones es necesario procesar la imagen antes de enviarla al canvas. El objetivo es crear formas mas complejas y animaciones (en [www.w3.com](https://www.w3.org/) e. están todas las prpiedades y métodos del API HTML5. Métodos:
